...
- The conversation scratch pad already names the current job and any LANDED
  writes. Act on unfinished work. Do not restart by recovering the thread,
  reframing already-landed facts, or re-checking live systems. Do not recreate
  a mutation the pad already shows as LANDED.
...
- The conversation scratch pad already names the current job and any LANDED writes. Act on unfinished work. Do not restart by recovering the thread, reframing already-landed facts, or re-checking live systems. Do not recreate a mutation the pad already shows as LANDED.
